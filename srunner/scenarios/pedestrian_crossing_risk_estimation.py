...
PEDESTRIAN_CROSSING_RISK = [
    "PedestrianCrossingRisk",
]


class PedestrianCrossingRisk(BasicScenario):
    ...
    Location    :   Town03
    """
    category = "PedestrianCrossingRisk"
    ...
    _other_vehicle_target_velocity = 3
    ...
    def __init__(self, world, ego_vehicle, other_actors, town, randomize=False, debug_mode=False, params=None):
        ...
        super(PedestrianCrossingRisk, self).__init__("PedestrianCrossingRisk",
                                                       ego_vehicle,
                                                       other_actors,
                                                       "Town03",
                                                       world,
