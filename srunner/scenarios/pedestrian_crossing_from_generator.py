...
class PedestrianCrossingAutoGenerated():
    """
    ...
    _cell_distance_walker = 2.3 # meters
    ...
    def _create_behavior(self):
        ...
        # Build behavior tree
        sequence = py_trees.composites.Parallel("Sequence Behavior")
        sequence_ego = py_trees.composites.Sequence("Sequence Behavior")
        sequence_leading = py_trees.composites.Sequence("Sequence Behavior")
        sequence_walker = py_trees.composites.Sequence("Sequence Behavior")
