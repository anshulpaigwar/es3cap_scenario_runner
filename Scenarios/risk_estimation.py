...
class RiskEstimation(BasicScenario):
    ...
    _ego_vehicle_start = carla.Transform(
        carla.Location(x=6.4, y= -130.8, z=0.5), carla.Rotation(yaw=271.5))
    ...
    # other vehicle
    # _other_vehicle_model = 'vehicle.kawasaki.ninja'
    _other_vehicle_model = 'vehicle.tesla.model3'
    _other_vehicle_start = carla.Transform(
        carla.Location(x=-70, y=-135, z=0.5), carla.Rotation(yaw=1.5))
    ...
    def __init__(self, world, debug_mode=False, params = None):
        ...
        super(RiskEstimation, self).__init__(
            name="RiskEstimation",
            town="Town03",
            world=world,
    ...
    def _create_behavior(self):
        ...
        keep_velocity_parallel.add_child(stop_other_sequence)
...
class RiskEstimation2(BasicScenario):
    ...
    _other_vehicle_model = 'vehicle.kawasaki.ninja'
    _other_vehicle_start = carla.Transform(
        carla.Location(x=7.8, y=-186.8, z=0.5), carla.Rotation(yaw=91.5))
        # carla.Location(x=-30, y=-135, z=0.5), carla.Rotation(yaw=1.5))
    # _other_vehicle_start = carla.Transform(
    #     carla.Location(x=-105, y=-136, z=0.5), carla.Rotation(yaw=0))
    _other_vehicle_max_brake = 1.0
    ...
    def __init__(self, world, debug_mode=False, params = None):
        ...
        super(RiskEstimation2, self).__init__(
            name="RiskEstimation2",
            town="Town03",
            world=world,
            debug_mode=debug_mode)
